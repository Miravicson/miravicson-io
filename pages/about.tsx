...
export default function about() {
  return (
    <ContainerBlock
      title="About &mdash; Victor Ughonu"
      description="I am a Senior FullStack Developer at Kudi.com. I lead the design and development of Internal Tools used to empower my colleagues to be productive. I am passionate about Artificial Intelligence and Deep Learning. In my spare time, you would find me training an AI model or trying to beat my record score on Kaggle."
    >
      <Header>
